...
import {
  Blend, Circle, CircleDotDashed, CircleOff, Code2, Coffee, Contrast, Crop, Eraser,
  FileImage, FlipHorizontal2, Frame, Grid3X3, Images, Maximize2, Minimize2, Palette,
  Pipette, RefreshCw, RotateCw, Scaling, ScanFace, ShieldCheck, SlidersHorizontal,
